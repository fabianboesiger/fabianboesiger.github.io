...
Es gibt verschiedene Möglichkeiten, der oben beschriebenen Tendenz gegenzuwirken oder $K_A / K_S$ konstant zu halten oder gar zu erhöhen. Der Anteil der Löhne kann durch Regulationen und Gesetze "künstlich", also nicht durch einen Marktmechanismus, erhöht werden. Ein Beispiel dafür ist ein bedingungsloses Grundeinkommen. Wenn die Finanzierung durch eine Besteuerung des Kapitals erfolgt, ist es letztendlich nichts anderes als eine Lohnerhöhung. Dieses Grundeinkommen wird dann wieder ausgegeben, was die Gewinne wiederum erhöht.
