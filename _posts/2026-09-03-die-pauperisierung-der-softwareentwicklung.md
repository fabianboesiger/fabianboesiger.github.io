...
Was geschah mit den Webern? England fiel der Wochenlohn eines Handwebers von rund 20–30 Shilling auf unter 5 Shilling. Die Handweber versuchten, den Verfall ihrer Löhne durch Mehrarbeit zu kompensieren. Sie arbeiteten 14 bis 18 Stunden täglich, bezogen ihre Kinder in die Arbeit ein und lebten Dennoch unter dem Existenzminimum. Dieses Phänomen der Verarmung ganzer Bevölkerungsschichten kennt man heute als Pauperismus.

Es kam zu verschiedenen Aufständen. Organisierte Banden von Textilarbeitern drangen nachts in Fabriken ein und zerschlugen gezielt die Webmaschinen. Die britische Regierung führte darauf folgend auf die Zerstörung von Maschinen ab 1812 die Todesstrafe ein.

Doch dem endgültigen Schicksal konnten die Weber nicht entrinnen. Nach und nach gaben diese ihre Unabhängigkeit auf und gliederten sich in die Fabriken ein. Dort bedienten sie die Maschinen, die sie zuvor bekämpft hatten, natürlich zu drastisch schlechteren Bedingugnen. Viele andere Handweber verliessen ihre Heimatdörfer und wanderten in die Vereinigten Staaten aus, um dort ein neues Leben in der Landwirtschaft aufzubauen.

Als Softwareentwickler hoffe ich natürlich, dass es uns nicht ganz so hart treffen wird, doch ich bin überzeugt, dass es in dieselbe Richtung geht. Aus einem hochangesehenem Handwerk wird nichts weiter als eine Fabrikarbeit. Löhne werden sinken und viele werden sich andere Jobs suchen. 

Die Webmaschine und die KI sind aber keineswegs Einzelfälle, solche explosionsartige Entwicklungen gab es im  Lauf der Geschichte immer wieder: der Buchdruck, der die Schreiber ersetzte, die Fliessbandfertigung, die hochqualifizierte Schlosser und Mechaniker ersetzte, der Frachtcontainer, der viele Hafenarbeiter ersetzte, die Fotografie, welche die Maler ersetzte, die Eisenbahn, der die Kutscher ersetzte, der Computer, der die menschlichen Rechner ersetzte.

Nun mag es Gegenargumente geben, das KI revolutionärer ist als alles andere, weil es eben gerade Intelligenz automatisiert. KI-Modelle entstehen, indem das kollektive geistige Produkt der Menschheit, also Texte, Open-Source-Code, Kunstwerke, Forenbeiträge und so weiter abgegriffen und als Trainingsdaten angesammelt werden. Das Wissen der Allgemeinheit wird privatisiert und in Modellgewichte gegossen. Was früher jahrelange Bildung, Denkzeit und Erfahrung eines Menschen erforderte, wird nun pro Token eingekauft.

Doch genau eben dieser Punkt zeigt gerade, dass diese Entwicklung keineswegs revolutionär ist, sondern nur eine natürliche Folge der kapitalistischen Produktionsweise. Genau wie der Webstuhl physisches Geschick und Motorik des Menschen abgelöst und in eiserne Mechanik gegossen hat, oder der Computer formale Logik und Aritmetik als elektronische Schaltkreise ausdrückt, so löst die KI nun Synthese, Semantik und Abstraktion ab, und degradiert sie von menschlicher Kunst zu einer blossen Ware, die gekauft und verkauft werden kann.
